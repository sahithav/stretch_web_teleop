"""
ArUco detection utilities for visual servoing
...
class ArucoMarkerCollection:
    ...
    def update(self, rgb_image, rgb_camera_info):
        ...
        # detection in low exposure time images
...
class ArucoDetector():
    def __init__(self, marker_info=None, show_debug_images=False, use_apriltag_refinement=False, brighten_images=False):
        ...
        self.aruco_marker_collection = ArucoMarkerCollection(
            self.marker_info, self.show_debug_images, self.use_apriltag_refinement, self.brighten_images
        )
